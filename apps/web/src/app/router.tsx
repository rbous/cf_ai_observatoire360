...
function PageLoader() {
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#B3E5FC] to-white">
            <div className="flex flex-col items-center gap-4">
                <div
                    className="w-12 h-12 rounded-full border-4 border-[#008B8B] border-t-transparent animate-spin"
                />
                <p className="text-[#1A2332] font-medium">Chargement…</p>
            </div>
        </div>
    );
}
