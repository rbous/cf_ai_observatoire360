...
>(({ className, ...props }, ref) => (
    <TabsPrimitive.Trigger
        ...
        className={cn(
            ...
            "data-[state=active]:bg-white data-[state=active]:text-[#008B8B] data-[state=active]:shadow-sm",
            "data-[state=inactive]:text-gray-500 data-[state=inactive]:hover:text-[#008B8B]",
            className
        )}
        {...props}
    />
