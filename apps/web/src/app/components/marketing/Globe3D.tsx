...
function GlobeFallback() {
    return (
        <div className="w-full h-full flex items-center justify-center">
            <div className="w-48 h-48 rounded-full bg-gradient-to-br from-[#1a6b8a] to-[#137fec] animate-pulse opacity-60" />
        </div>
    );
}
        ...
        <div className="w-full h-full min-h-[320px]" aria-hidden="true">
            <Suspense fallback={<GlobeFallback />}>
                ...
                >
                    ...
                    <pointLight position={[0, -5, 2]} intensity={0.2} color="#137fec" />
                    <EarthSphere />
                </Canvas>
            </Suspense>
        </div>
