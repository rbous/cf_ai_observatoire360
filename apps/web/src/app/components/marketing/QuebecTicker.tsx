...
export default function QuebecTicker() {
    return (
        <div className="w-full py-12 bg-gradient-to-b from-white to-[#f0fafa]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-6 text-center">
                <h3 className="text-xl sm:text-2xl font-black uppercase text-[#1A2332] tracking-wide">
                    ADAPTÉ AU{" "}
                    <span className="text-[#008B8B]">QUÉBEC</span>
                </h3>
                <div className="mt-2 w-12 h-1 bg-[#D4A843] mx-auto rounded-full" />
            </div>

            <div className="w-full bg-[#1A2332] py-4 overflow-hidden select-none" aria-hidden="true">
                <div
                ...
                >
                    {ITEMS_DOUBLED.map((item, index) => (
                        ...
                        >
                            <span className="text-[#008B8B] text-lg" aria-hidden="true">❄</span>
                            {item}
                        </span>
                    ))}
                </div>
